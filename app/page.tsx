    ...
    >
      ...
      <ViewerProvider>
        <PageShell>
          ...
          >
            <p className="text-sm leading-relaxed text-gray-600 dark:text-[#cccccc]">{t("intro_1")}</p>
            <p className="text-sm leading-relaxed text-gray-600 dark:text-[#cccccc]">{t("intro_2")}</p>
            <p className="text-sm leading-relaxed text-gray-600 dark:text-[#cccccc]">{t("intro_3")}</p>
          </div>
          ...
          <div className="block sm:hidden px-3 pb-4 mt-4 max-w-3xl mx-auto">
            ...
            <section className="mb-4">
              <h3 className="mb-1 font-bold uppercase tracking-wide text-xs text-gray-700 dark:text-[#cccccc]">{t("address")}</h3>
              <p className="whitespace-pre-line text-xs text-gray-500 dark:text-[#4d4d4d]">{t("location")}</p>
            </section>
            {/* Contacto */}
            <section className="mb-4">
              <h3 className="mb-1 font-bold uppercase tracking-wide text-xs text-gray-700 dark:text-[#cccccc]">{t("contact")}</h3>
              <ul className="space-y-1">
                <li>
                  <a href={`mailto:${t("email")}`} className="underline hover:opacity-80 text-xs text-gray-500 dark:text-[#4d4d4d]">
                    {t("email")}
                  </a>
                </li>
                <li>
                  <a href="/cv.pdf" target="_blank" rel="noopener" className="underline hover:opacity-80 text-xs text-gray-500 dark:text-[#4d4d4d]">
                    CV
                  </a>
                </li>
                <li>
                  <a href="https://github.com/" target="_blank" rel="noopener" className="underline hover:opacity-80 text-xs text-gray-500 dark:text-[#4d4d4d]">
                    GitHub
                  </a>
                </li>
              </ul>
            ...
            <section className="mb-2">
              <h3 className="mb-1 font-bold uppercase tracking-wide text-xs text-gray-700 dark:text-[#cccccc]">{t("social")}</h3>
              <ul className="space-y-1">
                <li>
                  <a href="https://github.com/" target="_blank" rel="noreferrer" className="underline hover:opacity-80 text-xs text-gray-500 dark:text-[#4d4d4d]">
                    {t("github_link")}
                  </a>
                </li>
                <li>
                  <a href="#" className="underline hover:opacity-80 text-xs text-gray-500 dark:text-[#4d4d4d]">
                    {t("twitter_link")}
                  </a>
                </li>
              </ul>
          ...
          <SectionRow id="contact" label={t("contact")} hint={t("lets_work_together")} spacing="xl">
            <div className="flex flex-wrap items-center gap-3">
              <a
                href={`mailto:${t("email")}`}
                className="inline-flex items-center gap-2 rounded-md ring-1 ring-gray-300/80 bg-white px-3 py-2 text-xs text-gray-700 hover:bg-gray-200 active:bg-gray-300 focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-gray-400 dark:ring-[#4d4d4d] dark:bg-[#1a1a1a] dark:text-[#cccccc] dark:hover:bg-[#000000] dark:active:bg-[#1a1a1a] dark:focus-visible:ring-[#4d4d4d] transition-colors"
              >
              ...
              <a
                href="#"
                className="inline-flex items-center gap-1 rounded-md ring-1 ring-gray-300/80 bg-gray-900 px-3 py-2 text-xs text-white hover:bg-gray-800 active:bg-gray-700 focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-gray-400 dark:ring-[#4d4d4d] dark:bg-[#ffffff] dark:text-[#000000] dark:hover:bg-[#cccccc] dark:active:bg-[#aaaaaa] dark:focus-visible:ring-[#4d4d4d] transition-colors"
              >
